...
- [[fact-0001]] — Obsidian wiki can replace PostgreSQL for personal agent memory *(active)*
- [[fact-0002]] — LLM can serve as the semantic engine instead of vector embeddings *(active)*
- [[fact-0003]] — Vault structure bootstrapped successfully *(active)*
...
- [[user-profile]] — Agent's own profile
...
- [[cluster-001]] — Cluster: Memory Architecture Design
