...
- [[2026-05-06]] — Design EverMemOS-compatible memory vault (2 MemCells)
...
- [[fact-0001]] — Obsidian wiki can replace PostgreSQL for personal agent memory
- [[fact-0002]] — LLM can serve as the semantic engine instead of vector embeddings
- [[fact-0003]] — Vault structure bootstrapped successfully
...
- [[pred-0001]] — grep+LLM retrieval will remain under 2s at 500 notes *(pending)*
...
- [[ep-0001]] — Design and bootstrap memory vault
...
- [[agent-profile]] — Agent's own behavioral traits and preferences
- [[user-profile]] — What the agent knows about the user
...
- [[cluster-001]] — Memory Architecture Design (2 MemCells)
